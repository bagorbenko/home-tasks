...
A = input('Введите объем большего ведра А:  ')
B = input('Введите объем ведра В:  ')
rez = input('Введите расчитываемый объем:  ')
while not A.isdigit() or not B.isdigit() or not rez.isdigit():
    A = input('Введите объем большего ведра А:  ')
    B = input('Введите объем ведра В:  ')
    rez = input('Введите расчитываемый объем:  ')
    print('Вводите только числовые параметры')
print("Начинайте переливание")
A1 = 0 #литраж воды между операциями
B1 = 0

if A == B:
    print('Решений не существует')
    quit('Попробуйте заново')
